...
// const run = x => `this is run function with para x : ${x}`;
...
// console.log(obj.eat("ice cream"));
// console.log(obj.test());

// const myString = new String("Min ga lar pr");
...
// console.log(myString.replace("ga","za"));

// console.log(myString.search("ga"));
// console.log(myString.search("za"));

// console.log("AB".padEnd(12,"Y"));
// console.log("AB".padStart(8,"0"));
...
// const letters = ['a','b','b','c','a','c','d','a'];

// let sum = 0;
// let count = {};
// const consoleNumber = (item,index,arr)=>{
//   // console.log('a['+index+ ']  =' +item + ' in '+ arr);
...
// console.log(fruits.includes("zzz"));
...
// console.log(fruits.splice(1,2,"Aaa","aavvv","CCCdfsfs"));
// console.log(fruits);

// console.log([...fruits,"hein","htet zaw",...arr,...nums,...arr]);
...
//   title = "MMS "+ product.title.toUpperCase();
...
// });
// const newArr = products.filter((product)=>
// // product.id === 5 || product.id == 15 || product.id == 20
// //  product.id !==5
// // [1,3,5,7].includes(product.id)
...
// const arrR = ["a",'b','c','d','e','f','g'];

// const str = arrR.reduce((pv,cv) => console.log(pv,cv),'o')
...
// const showAlert = () => alert("you clicked");
...
// text.addEventListener("focus", () => console.log("Focus Event"));
// text.addEventListener("blur", () => console.log("blur Event"));
// text.addEventListener("change", () => console.log("change Event"));
...
//   console.log(count);
//   if (count > 3) {
//     btn.removeEventListener("click", showAlertt);
//   }
// };
// btn.addEventListener("click", showAlertt);
